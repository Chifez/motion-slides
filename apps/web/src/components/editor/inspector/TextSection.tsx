  ...
  return (
    <div className="px-3 py-3 border-b border-(--ms-border)">
      ...
      <div className="grid grid-cols-[1fr_auto] gap-2 mb-2">
        ...
        <div className="flex flex-col gap-0.5">
          <span className="text-[10px] text-(--ms-text-muted) uppercase tracking-wider">Style</span>
          <button
      ...
      <textarea
        ...
        className="w-full bg-(--ms-bg-base) border border-(--ms-border) rounded-md px-2.5 py-2 text-[12px] text-(--ms-text-primary) focus:outline-none focus:border-blue-500 resize-y min-h-[56px] font-sans transition-colors"
      />
    </div>
  )
}
