  ...
  switch (toolName) {
    case 'addShapeElement': {
      ...
      const newElement: SceneElement = {
        ...
        content: {
          ...
          fill: fill || (finalShapeType === 'aws-icon' || finalShapeType === 'gcp-icon' || finalShapeType === 'icon' ? 'transparent' : 'rgba(59, 130, 246, 0.15)'),
          stroke: stroke || (finalShapeType === 'aws-icon' || finalShapeType === 'gcp-icon' || finalShapeType === 'icon' ? 'transparent' : '#3b82f6'),
          strokeWidth: 1.5,
          textColor: '#ffffff',
        } as ShapeContent,
      }
    ...
    case 'addSectionElement': {
      const {
        ...
        borderStyle = 'dashed', cornerRadius = 12, slideIndex, id,
      } = args as {
      ...
      rawNodes.forEach(n => {
        ...
        finalElements.push({
          ...
          content: {
            ...
            sublabel: n.sublabel,
            iconPath: resolvedIcon,
            fill: n.fill || (finalShapeType === 'aws-icon' || finalShapeType === 'gcp-icon' || finalShapeType === 'icon' ? 'transparent' : 'rgba(59, 130, 246, 0.15)'),
            stroke: n.stroke || (finalShapeType === 'aws-icon' || finalShapeType === 'gcp-icon' || finalShapeType === 'icon' ? 'transparent' : '#3b82f6'),
            strokeWidth: 1.5,
            textColor: '#ffffff',
          } as ShapeContent,
        })
