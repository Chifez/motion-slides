...
import { Plus, Copy, Trash2, Sparkles, Type, Code2, Square, Minus, ChevronDown, ChevronRight, X } from 'lucide-react'
...
function ElementRow({ element }: { element: SceneElement }) {
  ...
  return (
    <button
      ...
      className={`w-full flex items-center gap-1.5 px-2 py-[3px] rounded text-left cursor-pointer border-none transition-colors ${isSelected
