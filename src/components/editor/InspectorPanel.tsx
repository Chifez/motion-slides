      ...
      {element.type === 'code' && (
        <div className={sectionCls}>
          ...
          <textarea
            ...
            spellCheck={false}
            className="w-full bg-[#0d1117] border border-white/[0.08] rounded-md px-2.5 py-2 text-[12px] text-[#e2e8f0] focus:outline-none focus:border-blue-500 resize-y min-h-[120px] font-mono"
          />
        </div>
      )}
